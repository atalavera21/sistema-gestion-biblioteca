...
|---|---|---|---|
| **Lenguaje** | Java SE | 21 (LTS) | Ultima version LTS con soporte extendido. Compatible con Jakarta EE 10 y WildFly 35. |
| **Servidor de aplicaciones** | WildFly | 35 | Servidor Java EE / Jakarta EE maduro, ligero, con soporte nativo para JSF, CDI, JPA y JAX-RS. |
...
```mermaid
graph LR
    Java[Java 21 LTS] --> WildFly[WildFly 35]
    WildFly --> JSF
    WildFly --> CDI
    WildFly --> JPA
...
| Componente | Tecnologia | Version | Rol en el proyecto |
|---|---|---|---|
| **PDF** | Apache PDFBox | 3.0+ | Motor de reportes. Genera PDF programáticamente desde consultas JPQL. Reemplaza a JasperReports (conflictos con dependencias JAXB obsoletas). |
| **Excel** | Apache POI | 5.3+ | Generacion de archivos Excel (.xlsx) directamente desde consultas JPQL. |
| **JPQL** | Hibernate HQL/JPQL | — | Consultas orientadas a objetos para alimentar los reportes. |
